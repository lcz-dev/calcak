...
const TRENDING_DATA = {
  global: [
    ...
    { text: '2025 tax brackets updated — check your refund',       tag: 'Tax',       calc: 'tax'        },
    ...
    { text: 'BMI guidelines updated for 2025',                     tag: 'Health',    calc: 'bmi'        },
  ],
  standard: [
  ...
  bmi: [
    { text: 'New BMI categories for 2025',                         tag: 'Health',    calc: 'bmi'        },
  ...
  tax: [
    { text: '2025 standard deduction increased to $15,000',        tag: 'Tax',       calc: 'tax'        },
    { text: 'IRS announces new withholding tables for 2025',       tag: 'Tax',       calc: 'tax'        },
  ...
  tip: [
    ...
    { text: 'How much to tip your delivery driver in 2025',        tag: 'Dining',    calc: 'tip'        },
    { text: 'Restaurant tipping etiquette guide 2025',             tag: 'Dining',    calc: 'tip'        },
  ],
  loan: [
    ...
    { text: 'Best personal loan rates in April 2025',              tag: 'Finance',   calc: 'loan'       },
  ],
  percentage: [
